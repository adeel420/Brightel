      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-10 items-center py-20">
          <div>
            <p
              data-hero
              className="text-[11px] uppercase tracking-widest text-[#fdb81e] font-medium"
            >
              Brightel Tax Services – Business Accounting Experts
            </p>
            <h2
              data-hero
              className="mt-2 text-3xl sm:text-4xl md:text-5xl font-semibold text-white drop-shadow-md"
            >
            ...
            <p data-hero className="mt-4 text-slate-100 max-w-xl drop-shadow">
              ...
              Compliance for businesses—helping you stay audit-ready, compliant,
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 grid lg:grid-cols-2 gap-10 items-center">
          <div data-reveal>
            ...
            <p className="mt-4 text-slate-700 leading-relaxed">
              At Brightel Tax Services, we’re more than tax preparers — we’re
              your financial partners. Our team helps small and mid-sized
              companies gain control of their finances through accurate
              reporting, proactive compliance, and scalable accounting systems.
            </p>
            <p className="mt-4 text-slate-700 leading-relaxed">
              Whether you’re a retail franchise, medical office, convenience
              store, or government contractor, we ensure your books are precise,
              your filings are on time, and your financials reflect the real
      ...
      <section id="industries" ref={industriesRef} className="bg-white">
        <div className="mx-auto max-w-7xl px-4 py-12" data-reveal>
          ...
          <div className="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              {
                name: "Restaurants & Franchise Owners",
                icon: <FaUtensils className="text-[#fdb81e] text-2xl" />,
              },
              {
                name: "Medical & Dental Offices",
                icon: <FaStethoscope className="text-[#fdb81e] text-2xl" />,
              },
              {
                name: "Convenience Stores & Gas Stations",
                icon: <FaGasPump className="text-[#fdb81e] text-2xl" />,
              },
              {
                name: "Retail & E-Commerce",
                icon: <FaShoppingCart className="text-[#fdb81e] text-2xl" />,
              },
              {
                name: "Professional & Service Firms",
                icon: <FaBriefcase className="text-[#fdb81e] text-2xl" />,
              },
              {
                name: "Construction & Trade Businesses",
                icon: <FaHardHat className="text-[#fdb81e] text-2xl" />,
              },
              {
                name: "Government Contractors",
                icon: <FaLandmark className="text-[#fdb81e] text-2xl" />,
              },
              {
                name: "Nonprofits",
                icon: <FaHandsHelping className="text-[#fdb81e] text-2xl" />,
              },
              {
                name: "Technology & Startups",
                icon: <FaLaptopCode className="text-[#fdb81e] text-2xl" />,
              },
            ].map((item, i) => (
              <div
                key={i}
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    Specialized bookkeeping, compliance, and reporting tailored
                    to your model.
                  </p>
                </div>
              </div>
      ...
      <section id="dates" ref={datesRef} className="bg-[#f5f6f7]">
        <div className="mx-auto max-w-7xl px-4 py-12">
          <div className="grid lg:grid-cols-2 gap-20 items-stretch">
            <div data-reveal>
              <h3 className="text-lg font-semibold text-[#1a4480]">
                Tax Year Countdown & Key Filing Dates
              </h3>
                ...
                <table className="min-w-full bg-white text-sm">
                  ...
                  <tbody>
                    {[
                      ...
                      [
                        "Jan 31",
                        "W-2 & 1099 Forms Due to Employees/Contractors",
                        "Employers",
                      ],
                      [
                        "Mar 15",
                      ...
                      [
                        "Apr 15",
                        "C-Corp Returns & Q1 Estimated Taxes",
                        "C Corporations",
                      ],
                      ...
                      [
                        "Dec 31",
                        "Year-End Payroll, 401(k), and Expense Adjustments",
                        "All Employers",
                      ],
                    ].map((r, i) => (
      ...
      <section id="resources" ref={resourcesRef} className="bg-white">
        <div className="mx-auto max-w-7xl px-4 py-12" data-reveal>
          ...
          <p className="text-sm text-slate-700 mt-1">
            Save time — access commonly used IRS business forms directly from
            our site.
          </p>
            ...
            {[
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="h-10 w-10 rounded-full bg-[#fdb81e] text-[#1a4480] grid place-items-center font-bold">
                    ★
                  </div>
                  <div>
                    <p className="font-medium">{row[0]}</p>
                    <p className="text-sm text-slate-600">{row[1]}</p>
                    <span className="text-xs text-[#005ea2]">
                      Open PDF on IRS.gov →
                    </span>
                  </div>
                </div>
